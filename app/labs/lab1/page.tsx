...
browser as large hedings. There are 6 heading tags for different sizes: h1, h2,
...
tag to tell browsers to render the gaps.
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Get 1-2 yellow Idaho potatoes.</li>
                    <li>Peel the potatoes.</li>
                    <li>Cut the potatoes into thin strips.</li>
                    <li>Place in air fryer, sprinkle with salt.</li>
                    <li>Cook at 400 degrees for 15-20 minutes.</li>
                    <li>Remove and enjoy your fries!</li>
                </ol>
